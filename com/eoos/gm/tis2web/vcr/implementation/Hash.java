...
/* 131 */     StringBuffer tmp = new StringBuffer(4);
/* 132 */     long aval = arg;
/*     */     
/* 134 */     tmp.setLength(4);
/* 135 */     for (int i = 0; i < 4; i++, aval >>>= 16L) {
/* 136 */       tmp.setCharAt(i, (char)(int)aval);
/*     */     }
/* 138 */     return buzhash(tmp);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 148 */     long h = initial_hash;
/* 149 */     for (int i = 0; i < arg.length(); i++)
/* 150 */       h = h << 1L ^ h >>> 63L ^ mix_master[(arg.charAt(i) ^ arg.charAt(i) >>> 8) & 0xFF]; 
/* 151 */     return h;
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public Hash() {
/* 160 */     this.hash_code = initial_hash;
/*     */   }
/*     */ 
/*     */   
/*     */   public Hash(Hash hc) {
/* 165 */     this.hash_code = lhv(hc.hash_code);
/*     */   }
/*     */ 
/*     */   
/*     */   public Hash(boolean arg) {
/* 170 */     this.hash_code = arg ? hash_true : hash_false;
/*     */   }
/*     */ 
/*     */   
/*     */   public Hash(byte arg) {
/* 175 */     this.hash_code = mix_master[arg + 183 & 0xFF];
/*     */   }
/*     */ 
/*     */   
/*     */   public Hash(short arg) {
/* 180 */     this.hash_code = lhv(arg);
/*     */   }
/*     */ 
/*     */   
/*     */   public Hash(char arg) {
/* 185 */     this.hash_code = lhv(arg);
/*     */   }
/*     */ 
/*     */   
/*     */   public Hash(int arg) {
/* 190 */     this.hash_code = lhv(arg);
/*     */   }
/*     */ 
/*     */   
/*     */   public Hash(long arg) {
/* 195 */     this.hash_code = lhv(arg);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public Hash(String arg) {
/* 210 */     this.hash_code = buzhash(new StringBuffer(arg));
/*     */   }
/*     */ 
/*     */   
/*     */   public Hash(StringBuffer arg) {
/* 215 */     this.hash_code = buzhash(arg);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 230 */     return (this.hash_code == b.hash_code);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean not_equal(Hash b) {
/* 235 */     return (this.hash_code != b.hash_code);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean more(Hash b) {
/* 240 */     if (this.hash_code >>> 1L > b.hash_code >>> 1L)
/* 241 */       return true; 
/* 242 */     if (this.hash_code >>> 1L < b.hash_code >>> 1L) {
/* 243 */       return false;
/*     */     }
/* 245 */     return ((this.hash_code & 0x1L) > (b.hash_code & 0x1L));
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean less(Hash b) {
/* 250 */     return b.more(this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 257 */     Hash result = new Hash();
/* 258 */     this.hash_code ^= b.hash_code;
/* 259 */     return result;
/*     */   }
/*     */ 
/*     */   
/*     */   public Hash sag(Hash b) {
/* 264 */     StringBuffer tmp = new StringBuffer(8);
/* 265 */     Hash result = new Hash();
/* 266 */     long aval = this.hash_code;
/* 267 */     long bval = b.hash_code;
/*     */     
/* 269 */     tmp.setLength(8);
/* 270 */     for (int i = 0; i < 4; i += 2) {
/* 271 */       tmp.setCharAt(i, (char)(int)aval);
/* 272 */       aval >>>= 16L;
/* 273 */       tmp.setCharAt(i + 1, (char)(int)bval);
/* 274 */       bval >>>= 16L;
/*     */     } 
/*     */     
/* 277 */     result.hash_code = buzhash(tmp);
/* 278 */     return result;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/* 283 */   private static long NOSIGN = Long.MAX_VALUE;
/*     */ 
/*     */   
/*     */   public byte bag(byte b) {
/* 287 */     return (byte)(int)((this.hash_code & NOSIGN) % ((b < 0) ? -b : b));
/*     */   }
/*     */ 
/*     */   
/*     */   public short bag(short b) {
/* 292 */     return (short)(int)((this.hash_code & NOSIGN) % ((b < 0) ? -b : b));
/*     */   }
/*     */ 
/*     */   
/*     */   public char bag(char b) {
/* 297 */     return (char)(int)((this.hash_code & NOSIGN) % b);
/*     */   }
/*     */ 
/*     */   
/*     */   public int bag(int b) {
/* 302 */     return (int)((this.hash_code & NOSIGN) % ((b < 0) ? -b : b));
/*     */   }
/*     */ 
/*     */   
/*     */   public long bag(long b) {
/* 307 */     return (this.hash_code & NOSIGN) % ((b < 0L) ? -b : b);
/*     */   }
/*     */ }


/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\vcr\implementation\Hash.class
