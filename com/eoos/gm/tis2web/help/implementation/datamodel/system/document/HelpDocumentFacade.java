/*    */ package com.eoos.gm.tis2web.help.implementation.datamodel.system.document;
/*    */ 
/*    */ import com.eoos.gm.tis2web.help.implementation.datamodel.system.document.replacer.FileLinkReplacer;
...
/*    */ import com.eoos.gm.tis2web.help.implementation.datamodel.system.document.replacer.UnknownReplacer;
...
/*    */ 
/*    */ 
/*    */ public class HelpDocumentFacade
/*    */   extends HtmlDocumentManipulationFacade
/*    */ {
/* 21 */   private static final Logger log = Logger.getLogger(HelpDocumentFacade.class);
/*    */   
...
/* 38 */       super(HelpDocumentFacade.this.document, "/?\\{(IMAGE:FILE:|LINK:ID:|STYLE_SHEET:FILE:|LINK:FILE:)", "\\}");
/*    */     }
/*    */     
/*    */     public Object next() {
...
/* 47 */         retValue = new HelpDocumentLinkReplacer(tmp);
...
/*    */       } else {
/* 53 */         HelpDocumentFacade.log.warn("unknown replacer: " + tmp);
...
/*    */ 
/*    */   
/*    */   public HelpDocumentFacade(StringBuffer document) {
/* 63 */     super(document);
/*    */   }
/*    */   
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\help\implementation\datamodel\system\document\HelpDocumentFacade.class
