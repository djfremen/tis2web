...
/*  54 */     context.startAttribute("", "Label");
/*     */     try {
/*  56 */       context.text(this._Label);
...
/*     */         case 4:
/* 129 */           if ("" == ___uri && "Label" == ___local) {
/* 130 */             goto0();
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 2:
/* 135 */           if ("" == ___uri && "Locale" == ___local) {
/* 136 */             goto0();
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 0:
/* 141 */           revertToParentFromLeaveAttribute(___uri, ___local);
/*     */           return;
/*     */       } 
...
/*     */           case 1:
/*     */             try {
/* 152 */               LabelTypeImpl.this._Locale = value;
...
/*     */           case 3:
/*     */             try {
/* 160 */               LabelTypeImpl.this._Label = value;
...
/* 177 */       this.state = 0;
/* 178 */       int idx = this.context.getAttribute("", "Label");
/* 179 */       if (idx >= 0) {
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\ctoc\implementation\common\db\xml\impl\LabelTypeImpl.class
