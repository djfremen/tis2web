...
/* 28 */     super("smenu:" + context.createID(), null, "BookMarks");
/* 29 */     this.context = context;
/* 30 */     this.imgRendererCallback = (HtmlImgRenderer.Callback)new HtmlImgRenderer.CallbackAdapter() {
/*    */         public String getImageSource() {
/* 32 */           String image = "si/bookmarks.gif";
/* 33 */           if (BookmarkUIIconLink.this.isDisabled()) {
/* 34 */             image = "si/bookmarks-disabled.gif";
/*    */           }
/* 36 */           return "pic/" + image;
/*    */         }
/*    */ 
...
/* 41 */           return context.getLabel("si.tooltip.bookmarks");
/*    */         }
/*    */         
...
/* 57 */     MainHook.getInstance(this.context).switchUI(4);
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\si\implementation\i\\ui\html\common\ie\BookmarkUIIconLink.class
