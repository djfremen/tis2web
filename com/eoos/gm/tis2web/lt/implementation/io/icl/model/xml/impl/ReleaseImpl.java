...
/*     */ import com.eoos.gm.tis2web.lt.implementation.io.icl.model.xml.Release;
...
/*  39 */     context.startElement("", "Release");
...
/*  67 */       return ReleaseImpl.this;
/*     */     }
/*     */     
/*     */     public void enterElement(String ___uri, String ___local, Attributes __atts) throws UnreportedException {
/*  71 */       switch (this.state) {
/*     */         case 1:
/*  73 */           if ("" == ___uri && "Label" == ___local) {
/*  74 */             ReleaseImpl.this.getClass(); spawnSuperClassFromEnterElement(new ReleaseTypeImpl.Unmarshaller(ReleaseImpl.this, this.context), 2, ___uri, ___local, __atts);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\lt\implementation\io\icl\model\xml\impl\ReleaseImpl.class
