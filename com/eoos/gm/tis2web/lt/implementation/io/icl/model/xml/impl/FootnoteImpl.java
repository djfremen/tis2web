...
/*     */ import com.eoos.gm.tis2web.lt.implementation.io.icl.model.xml.Footnote;
...
/*  39 */     context.startElement("", "Footnote");
...
/*     */           break;
/*     */         case 1:
/*  80 */           if ("" == ___uri && "Sign" == ___local) {
/*  81 */             FootnoteImpl.this.getClass(); spawnSuperClassFromEnterElement(new FootnoteTypeImpl.Unmarshaller(FootnoteImpl.this, this.context), 2, ___uri, ___local, __atts);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */           return;
/*     */         case 2:
/*  98 */           if ("" == ___uri && "Footnote" == ___local) {
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\lt\implementation\io\icl\model\xml\impl\FootnoteImpl.class
