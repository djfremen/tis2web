...
/*     */ 
/*     */ public class ReleaseTypeImpl implements ReleaseType, UnmarshallableObject, XMLSerializable, ValidatableObject {
...
/*  90 */       return ReleaseTypeImpl.this;
/*     */     }
/*     */     
...
/*     */           return;
/*     */         case 2:
/* 120 */           if ("" == ___uri && "Label" == ___local) {
/* 121 */             this.context.popAttributes();
/* 122 */             this.state = 3;
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 5:
/* 127 */           if ("" == ___uri && "Value" == ___local) {
...
/*     */           case 4:
/*     */             try {
/* 163 */               ReleaseTypeImpl.this._Value = value;
...
/*     */           case 1:
/*     */             try {
/* 171 */               ReleaseTypeImpl.this._Label = value;
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\lt\implementation\io\icl\model\xml\impl\ReleaseTypeImpl.class
