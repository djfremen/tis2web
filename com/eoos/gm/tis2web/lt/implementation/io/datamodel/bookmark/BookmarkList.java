...
/*    */   
/*    */   private static final String KEY_LIST = "lt.bookmarks";
/*    */   
...
/* 36 */       this.list = (LinkedList)fmi.getPersistentObject(context.getSessionID(), "lt.bookmarks");
...
/* 60 */       return fmi.setPersistentObject(this.context.getSessionID(), "lt.bookmarks", this.list).booleanValue();
...
/*    */   }
/*    */   
/*    */   public boolean addBookmark(SIOLT ltElement) {
/* 68 */     return addBookmark(ltElement, null);
/*    */   }
/*    */   
/*    */   public boolean addBookmark(SIOLT ltElement, String name) {
/* 72 */     boolean retValue = true;
/*    */     
/* 74 */     Bookmark newBookmark = new Bookmark(ltElement.getID().intValue(), name);
/*    */     
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\lt\implementation\io\datamodel\bookmark\BookmarkList.class
