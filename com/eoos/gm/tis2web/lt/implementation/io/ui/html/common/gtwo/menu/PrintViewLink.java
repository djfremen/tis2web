...
/*  79 */     RE reLinkEnd = new RE(reLinkEndProg);
/*  80 */     StringBuffer tmp = new StringBuffer(getCode());
/*     */ 
/*     */     
/*  83 */     SectionIndex index = null;
/*  84 */     while ((index = StringUtilities.getSectionIndex(tmp.toString(), "<!--XPRINT-->", "<!--/XPRINT-->", 0, true, false)) != null) {
/*  85 */       StringUtilities.replaceSectionContent(tmp, index, "");
/*     */     }
/*     */ 
/*     */     
/*  89 */     index = null;
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\lt\implementation\i\\ui\html\common\gtwo\menu\PrintViewLink.class
