...
/*     */ import com.eoos.gm.tis2web.registration.common.xml.CHUNK;
...
/*     */           return;
/*     */         case 1:
/* 108 */           if ("" == ___uri && "ChunkNo" == ___local) {
/* 109 */             CHUNKImpl.this.getClass(); spawnSuperClassFromEnterAttribute(new CHUNKTypeImpl.Unmarshaller(CHUNKImpl.this, this.context), 2, ___uri, ___local);
/*     */             return;
/*     */           } 
/* 112 */           if ("" == ___uri && "Data" == ___local) {
/* 113 */             CHUNKImpl.this.getClass(); spawnSuperClassFromEnterAttribute(new CHUNKTypeImpl.Unmarshaller(CHUNKImpl.this, this.context), 2, ___uri, ___local);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */       } 
...
/* 153 */       this.state = 1;
/* 154 */       int idx = this.context.getAttribute("", "Data");
/* 155 */       if (idx >= 0) {
/* 156 */         this.context.consumeAttribute(idx);
/*     */         return;
/*     */       } 
/* 159 */       idx = this.context.getAttribute("", "ChunkNo");
/* 160 */       if (idx >= 0) {
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\registration\common\xml\impl\CHUNKImpl.class
