...
/*     */ import com.eoos.gm.tis2web.registration.common.xml.LICENSEKEY;
...
/*  23 */     return "LICENSE_KEY";
/*     */   }
/*     */   
/*     */   private static final Class PRIMARY_INTERFACE_CLASS() {
/*  27 */     return LICENSEKEY.class;
/*     */   }
/*     */   
...
/*  39 */     context.startElement("", "LICENSE_KEY");
...
/*  67 */       return LICENSEKEYImpl.this;
/*     */     }
/*     */     
/*     */     public void enterElement(String ___uri, String ___local, Attributes __atts) throws UnreportedException {
/*  71 */       switch (this.state) {
/*     */         case 1:
/*  73 */           if ("" == ___uri && "CHUNK" == ___local) {
/*  74 */             LICENSEKEYImpl.this.getClass(); spawnSuperClassFromEnterElement(new LICENSEKEYTypeImpl.Unmarshaller(LICENSEKEYImpl.this, this.context), 2, ___uri, ___local, __atts);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */           return;
/*     */         case 0:
/*  82 */           if ("" == ___uri && "LICENSE_KEY" == ___local) {
...
/*     */         case 2:
/*  95 */           if ("" == ___uri && "LICENSE_KEY" == ___local) {
...
/*     */           break;
/*     */         case 1:
/* 102 */           if ("" == ___uri && "LICENSE_KEY" == ___local) {
/* 103 */             LICENSEKEYImpl.this.getClass(); spawnSuperClassFromLeaveElement(new LICENSEKEYTypeImpl.Unmarshaller(LICENSEKEYImpl.this, this.context), 2, ___uri, ___local);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\registration\common\xml\impl\LICENSEKEYImpl.class
