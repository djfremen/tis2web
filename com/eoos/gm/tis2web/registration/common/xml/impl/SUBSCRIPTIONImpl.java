...
/*     */ import com.eoos.gm.tis2web.registration.common.xml.SUBSCRIPTION;
...
/*  39 */     context.startElement("", "SUBSCRIPTION");
...
/*  67 */       return SUBSCRIPTIONImpl.this;
/*     */     }
/*     */     
...
/*     */           return;
/*     */         case 0:
/*  76 */           if ("" == ___uri && "SUBSCRIPTION" == ___local) {
...
/*     */           return;
/*     */         case 2:
/*  92 */           if ("" == ___uri && "SUBSCRIPTION" == ___local) {
...
/*     */           return;
/*     */         case 1:
/* 108 */           if ("" == ___uri && "SubscriptionID" == ___local) {
/* 109 */             SUBSCRIPTIONImpl.this.getClass(); spawnSuperClassFromEnterAttribute(new SUBSCRIPTIONTypeImpl.Unmarshaller(SUBSCRIPTIONImpl.this, this.context), 2, ___uri, ___local);
/*     */             return;
/*     */           } 
/* 112 */           if ("" == ___uri && "Description" == ___local) {
/* 113 */             SUBSCRIPTIONImpl.this.getClass(); spawnSuperClassFromEnterAttribute(new SUBSCRIPTIONTypeImpl.Unmarshaller(SUBSCRIPTIONImpl.this, this.context), 2, ___uri, ___local);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */       } 
...
/* 153 */       this.state = 1;
/* 154 */       int idx = this.context.getAttribute("", "Description");
/* 155 */       if (idx >= 0) {
/* 156 */         this.context.consumeAttribute(idx);
/*     */         return;
/*     */       } 
/* 159 */       idx = this.context.getAttribute("", "SubscriptionID");
/* 160 */       if (idx >= 0) {
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\registration\common\xml\impl\SUBSCRIPTIONImpl.class
