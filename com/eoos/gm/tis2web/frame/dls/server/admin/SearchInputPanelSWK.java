...
/*    */ 
/*    */ public class SearchInputPanelSWK
/*    */   extends HtmlElementContainerBase {
/* 22 */   private static final Logger log = Logger.getLogger(SearchInputPanelSWK.class);
/*    */   private static String template;
/*    */   
/*    */   static {
/*    */     try {
/* 27 */       template = ApplicationContext.getInstance().loadFile(SearchInputPanelSWK.class, "searchinputpanel.html", null).toString();
...
/*    */   
/*    */   public SearchInputPanelSWK(final ClientContext context) {
...
/* 54 */           return SearchInputPanelSWK.this.executeSearch();
/*    */         }
/*    */       };
/*    */ 
/*    */     
...
/*    */       } else {
/* 70 */         getPanelStack().push((HtmlElement)new SearchResultPanelSWK(this.context, entries));
/* 71 */         object = null;
/*    */       } 
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\frame\dls\server\admin\SearchInputPanelSWK.class
