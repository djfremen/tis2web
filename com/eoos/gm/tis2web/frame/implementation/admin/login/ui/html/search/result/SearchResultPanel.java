...
/*     */ import com.eoos.gm.tis2web.frame.login.log.util.LoginLogUtil;
...
/*  73 */       this.listElement = new EntriesListElement(this.entries, context);
...
/* 211 */             LoginLogFacade.getInstance().delete(entries);
...
/*     */       try {
/* 231 */         log.info("exporing marked entries (" + entries.size() + ")...");
/* 232 */         byte[] data = LoginLogUtil.createExport(entries);
/* 233 */         ResultObject.FileProperties props = new ResultObject.FileProperties();
/* 234 */         props.filename = "login.log";
/* 235 */         props.mime = "text/plain; charset=utf-8";
/* 236 */         props.data = data;
/* 237 */         retValue = new ResultObject(13, true, true, props);
/* 238 */       } catch (Exception e) {
/* 239 */         log.error("....unable to delete entries - exception:" + e, e);
/*     */       } 
/*     */     }
/* 242 */     return retValue;
/*     */   }
...
/* 246 */     HtmlElementContainer container = getContainer();
/* 247 */     while (!(container instanceof HtmlElementStack) && container != null) {
/* 248 */       container = container.getContainer();
/*     */     }
/* 250 */     return (HtmlElementStack)container;
/*     */   }
/*     */   
/*     */   public String getHtmlCode(Map params) {
/* 254 */     StringBuffer retvalue = new StringBuffer(template);
/* 255 */     StringUtilities.replace(retvalue, "{MESSAGE}", this.truncated ? this.context.getMessage("search.result.truncated") : "");
/* 256 */     if (this.listElementPagedFront != null) {
/* 257 */       StringUtilities.replace(retvalue, "{LIST}", this.listElementPagedFront.getHtmlCode(params));
/* 258 */       StringUtilities.replace(retvalue, "{BUTTON_MARK_ALL}", this.buttonMarkAll.getHtmlCode(params));
/* 259 */       StringUtilities.replace(retvalue, "{BUTTON_INVERT}", this.buttonInvert.getHtmlCode(params));
/* 260 */       StringUtilities.replace(retvalue, "{BUTTON_RESET}", this.buttonReset.getHtmlCode(params));
/*     */     } else {
/*     */       
/* 263 */       StringUtilities.replace(retvalue, "{LIST}", this.context.getMessage("empty.search.result"));
/* 264 */       StringUtilities.replace(retvalue, "{BUTTON_MARK_ALL}", "");
/* 265 */       StringUtilities.replace(retvalue, "{BUTTON_INVERT}", "");
/* 266 */       StringUtilities.replace(retvalue, "{BUTTON_RESET}", "");
/*     */     } 
/*     */     
/* 269 */     if (this.selectionAction != null) {
/* 270 */       StringUtilities.replace(retvalue, "{INPUT_ACTION}", this.selectionAction.getHtmlCode(params));
/* 271 */       StringUtilities.replace(retvalue, "{BUTTON_ACTION}", this.buttonExecuteAction.getHtmlCode(params));
/*     */     } else {
/* 273 */       StringUtilities.replace(retvalue, "{INPUT_ACTION}", "");
/* 274 */       StringUtilities.replace(retvalue, "{BUTTON_ACTION}", "");
/*     */     } 
/* 276 */     StringUtilities.replace(retvalue, "{NEW_SEARCH_BUTTON}", this.buttonNewSearch.getHtmlCode(params));
/* 277 */     return retvalue.toString();
/*     */   }
/*     */ }


/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\frame\implementation\admin\logi\\ui\html\search\result\SearchResultPanel.class
