...
/*    */ 
/*    */ 
/*    */ public class ATask_LockLogins
/*    */   implements AdministrativeTask
/*    */ {
/*    */   private static final long serialVersionUID = 1L;
/* 21 */   private static final Logger log = Logger.getLogger(ATask_LockLogins.class);
/*    */   
...
/* 28 */     return ApplicationContext.getInstance().getLabel(locale, "disable.user.logins");
/*    */   }
/*    */ 
/*    */   
...
/*    */           try {
/* 40 */             ATask_LockLogins.log.info("disabling user logins");
/* 41 */             DefaultController.getInstance().disableLogins();
/*    */           }
...
/* 56 */         log.warn("failed to disable user logins for cluster server :" + url);
/*    */       }
/*    */     } 
/*    */     
...
/* 67 */     return ApplicationContext.getInstance().getMessage(locale, "user.logins.disalbe.failed");
/*    */   }
/*    */   
/*    */   public String getSuccessMessage(Locale locale) {
/* 71 */     return ApplicationContext.getInstance().getMessage(locale, "user.logins.disable.successful");
/*    */   }
/*    */ }


/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\frame\implementation\admin\tasks\ATask_LockLogins.class
