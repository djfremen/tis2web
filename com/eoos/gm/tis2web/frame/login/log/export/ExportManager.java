/*    */ package com.eoos.gm.tis2web.frame.login.log.export;
/*    */ 
...
/*    */   
/*    */   public void start() {
/* 36 */     log.info("starting");
/* 37 */     if (LoginLogFacade.getInstance().isEnabled() && LoginLogFacade.getInstance().supportsQuery()) {
/* 38 */       SubConfigurationWrapper subConfigurationWrapper = new SubConfigurationWrapper((Configuration)ApplicationContext.getInstance(), "frame.login.log.export.");
/*    */ 
/*    */       
/* 41 */       String exportServerName = subConfigurationWrapper.getProperty("server");
/* 42 */       if (ApplicationContext.getInstance().isLocalServer(exportServerName)) {
...
/*    */       } else {
/*    */         
/* 82 */         log.info("... this server is not the configured  export server");
/*    */       } 
/*    */     } else {
/*    */       
/* 86 */       log.info("...disabling all exports since configured login log facility is disabled or does not support queries");
/*    */     } 
/*    */   }
/*    */ }


/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\frame\login\log\export\ExportManager.class
