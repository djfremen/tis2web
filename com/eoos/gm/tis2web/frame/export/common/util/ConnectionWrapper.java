...
/*  97 */     return new PreparedStatementWrapper(this.delegate.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability), sql);
/*     */   }
/*     */   
/*     */   public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
/* 101 */     return new PreparedStatementWrapper(this.delegate.prepareStatement(sql, resultSetType, resultSetConcurrency), sql);
/*     */   }
/*     */   
/*     */   public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
/* 105 */     return new PreparedStatementWrapper(this.delegate.prepareStatement(sql, autoGeneratedKeys), sql);
/*     */   }
/*     */   
/*     */   public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
/* 109 */     return new PreparedStatementWrapper(this.delegate.prepareStatement(sql, columnIndexes), sql);
/*     */   }
/*     */   
/*     */   public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
/* 113 */     return new PreparedStatementWrapper(this.delegate.prepareStatement(sql, columnNames), sql);
/*     */   }
/*     */   
/*     */   public PreparedStatement prepareStatement(String sql) throws SQLException {
/* 117 */     return new PreparedStatementWrapper(this.delegate.prepareStatement(sql), sql);
/*     */   }
/*     */   
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\frame\export\commo\\util\ConnectionWrapper.class
