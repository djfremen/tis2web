...
/*    */ 
/*    */ 
/*    */ public class J2534DeviceDriverPermission
/*    */ {
/* 22 */   private static final Logger log = Logger.getLogger(J2534DeviceDriverPermission.class);
/*    */   
/*    */   private ClientContext context;
/*    */   
/* 26 */   private Set permittedDriverIDs = new HashSet();
/*    */   
/*    */   private J2534DeviceDriverPermission(ClientContext context) {
...
/* 33 */       for (Iterator<String> iter = aclService.getAuthorizedResources("J2534DeviceDriver", ACLService.ALL_RESOURCE_VALUES, usrGroup2Manuf, context.getSharedContext().getCountry()).iterator(); iter.hasNext();) {
...
/* 39 */       log.warn("unable to retrieve collection of permitted J2534 device drivers - exception:" + e, e);
/* 40 */       log.warn("disabling access to all drivers");
/* 41 */       this.permittedDriverIDs = Collections.EMPTY_SET;
/*    */     } 
/*    */   }
/*    */   
/*    */   public static J2534DeviceDriverPermission getInstance(ClientContext context) {
/* 46 */     synchronized (context.getLockObject()) {
/* 47 */       J2534DeviceDriverPermission instance = (J2534DeviceDriverPermission)context.getObject(J2534DeviceDriverPermission.class);
/* 48 */       if (instance == null) {
/* 49 */         instance = new J2534DeviceDriverPermission(context);
/* 50 */         context.storeObject(J2534DeviceDriverPermission.class, instance);
/*    */       } 
/* 52 */       return instance;
/*    */     } 
/*    */   }
...
/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\frame\export\common\permission\J2534DeviceDriverPermission.class
