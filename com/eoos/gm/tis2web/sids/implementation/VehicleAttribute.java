...
/*    */   }
/*    */   
/*    */   public VehicleAttribute(Integer id) {
/* 26 */     this.id = id;
...
/* 34 */         throw new DataModelException("missing attribute description (attribute=" + this.id + ",locale=" + locale + ")");
/*    */       }
/*    */     } else {
/* 37 */       throw new DataModelException("missing attribute description (attribute=" + this.id + ",locale=" + locale + ")");
/*    */     } 
...
/* 57 */     return "attribute-id:" + this.id + "(" + getDescription(Locale.ENGLISH) + ")";
/*    */   }
/*    */ }


/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\sids\implementation\VehicleAttribute.class
