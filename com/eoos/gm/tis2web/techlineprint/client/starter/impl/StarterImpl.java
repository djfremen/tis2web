...
/* 27 */             System.out.println("Can't load TechlinePrintBridge library. " + e);
/*    */           }
/* 29 */           if (e instanceof SecurityException) {
/* 30 */             System.out.println("Can't load TechlinePrintBridge library. " + e);
/*    */           }
/*    */         } 
/*    */       }
/* 34 */       return instance;
...
/* 52 */       return instance.getTech2WinComPort();
/*    */     } 
/*    */   }
/*    */   
/*    */   public boolean startProcess(String cmdLine) {
/* 57 */     synchronized (StarterImpl.class) {
/* 58 */       return instance.startProcess(cmdLine);
/*    */     } 
/*    */   }
/*    */   
/*    */   public boolean setEnvironment() {
/* 63 */     synchronized (StarterImpl.class) {
/* 64 */       return instance.setEnvironment();
/*    */     } 
/*    */   }
/*    */ }


/* Location:              D:\tech\G TIS\tis2web.jar!\com\eoos\gm\tis2web\techlineprint\client\starter\impl\StarterImpl.class
